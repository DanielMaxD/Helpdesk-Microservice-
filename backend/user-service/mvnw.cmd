...
# maven home pattern: ~/.m2/wrapper/dists/{apache-maven-<version>,maven-mvnd-<version>}/<hash>
if ($env:MVNW_REPOURL) {
...
$TMP_DOWNLOAD_DIR = New-Item -Itemtype Directory -Path "$($TMP_DOWNLOAD_DIR_HOLDER.Directory.FullName)\$($TMP_DOWNLOAD_DIR_HOLDER.BaseName).dir"
